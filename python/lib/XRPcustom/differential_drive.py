...
class DifferentialDrive:
    ...
    def __init__(self, left_motor: EncodedMotor, right_motor: EncodedMotor, imu: IMU = None, wheel_diam:float = 6.0, wheel_track:float = 12):
        """
        ...
        :param wheelTrack: The distance between the wheels in inches. Defaults to 12 cm.
    ...
    def turn(self, turn_degrees: float, max_effort: float = 0.5, timeout: float = 1.5, main_controller: Controller = None, secondary_controller: Controller = None, use_imu:bool = True) -> bool:
        """
